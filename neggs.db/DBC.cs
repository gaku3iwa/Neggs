namespace neggs.db
{
  ...
  public partial class DBC
  {
    ...
    public string ConnectionString => (settings == null) ? string.Empty : settings.ConnectionString;

    public string ProviderName => (settings == null) ? string.Empty : settings.ProviderName;
